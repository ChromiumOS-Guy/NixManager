...
NixManager is a GUI for un/installing and managing Nix package manager.

Originally started [here](https://gitlab.com/ChromiumOS-Guy/lomiri-system-settings/-/tree/nix-manager?ref_type=heads).
